...
def draw(mat, index, marker1, marker2, swapColor, rep, line):
    for i in range(index):
        ...
        if line == 0:
            pygame.draw.circle(win, swapColor, ((t*marker1), mat[marker1]), (t/2))
            pygame.draw.circle(win, swapColor, ((t*marker2), mat[marker2]), (t/2))
        elif line == 1:
